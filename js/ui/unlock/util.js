...
var CinnamonUserVerifier = class {
    constructor(client) {
        this._reauthOnly = true;
    ...
    _queueMessageTimeout() {
        ...
        GLib.Source.set_name_by_id(this._messageQueueTimeoutId, '[cinnamon] this._queueMessageTimeout');
    }
...
Signals.addSignalMethods(CinnamonUserVerifier.prototype);
