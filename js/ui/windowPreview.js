...
const { Atk, Cinnamon, Clutter, GLib, GObject,
    ...
    vfunc_allocate(container, box, flags) {
        ...
        //         continue;
            ...
            if (windowInfo) {
                ...
                child.allocate_preferred_size(0, 0, flags);
            }
        }
    }
...
var WindowPreview = GObject.registerClass({
    ...
    _init(metaWindow, workspace, overviewAdjustment) {
        ...
        global.log("windowPreview create WindowPreview");
    ...
    _addWindow(metaWindow) {
        ...
        Cinnamon.util_set_hidden_from_pick(clone, true);
    }
    ...
    vfunc_leave_event(crossingEvent) {
        ...
        GLib.Source.set_name_by_id(this._idleHideOverlayId, '[cinnamon] this._idleHideOverlayId');
