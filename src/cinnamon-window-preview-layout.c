...
G_DEFINE_TYPE_WITH_PRIVATE (CinnamonWindowPreviewLayout, cinnamon_window_preview_layout,
...
static void
cinnamon_window_preview_layout_get_property (GObject      *object,
                                          unsigned int  property_id,
                                          GValue       *value,
                                          GParamSpec   *pspec)
{
  CinnamonWindowPreviewLayout *self = CINNAMON_WINDOW_PREVIEW_LAYOUT (object);
  CinnamonWindowPreviewLayoutPrivate *priv;

  priv = cinnamon_window_preview_layout_get_instance_private (self);
...
static void
cinnamon_window_preview_layout_set_container (ClutterLayoutManager *layout,
                                           ClutterContainer     *container)
{
  CinnamonWindowPreviewLayout *self = CINNAMON_WINDOW_PREVIEW_LAYOUT (layout);
  CinnamonWindowPreviewLayoutPrivate *priv;
  ...
  parent_class = CLUTTER_LAYOUT_MANAGER_CLASS (cinnamon_window_preview_layout_parent_class);
  parent_class->set_container (layout, container);
}

static void
cinnamon_window_preview_layout_get_preferred_width (ClutterLayoutManager *layout,
                                                 ClutterContainer     *container,
                                                 float                 for_height,
                                                 float                *min_width_p,
...
static void
cinnamon_window_preview_layout_get_preferred_height (ClutterLayoutManager *layout,
                                                  ClutterContainer     *container,
                                                  float                 for_width,
                                                  float                *min_height_p,
...
static void
cinnamon_window_preview_layout_allocate (ClutterLayoutManager   *layout,
                                      ClutterContainer       *container,
...
static void
on_layout_changed (CinnamonWindowPreviewLayout *self)
{
  CinnamonWindowPreviewLayoutPrivate *priv;
  GHashTableIter iter;
  gpointer value;
...
on_window_size_position_changed (MetaWindow               *window,
                                 CinnamonWindowPreviewLayout *self)
{
                    ...
                    CinnamonWindowPreviewLayout *self)
{
  ...
  cinnamon_window_preview_layout_remove_window (self, window_info->window);
}

static void
cinnamon_window_preview_layout_dispose (GObject *gobject)
{
  CinnamonWindowPreviewLayout *self = CINNAMON_WINDOW_PREVIEW_LAYOUT (gobject);
  CinnamonWindowPreviewLayoutPrivate *priv;
  GHashTableIter iter;
  gpointer key, value;
  ...
  G_OBJECT_CLASS (cinnamon_window_preview_layout_parent_class)->dispose (gobject);
}

static void
cinnamon_window_preview_layout_init (CinnamonWindowPreviewLayout *self)
{
  CinnamonWindowPreviewLayoutPrivate *priv;
...
static void
cinnamon_window_preview_layout_class_init (CinnamonWindowPreviewLayoutClass *klass)
{
  ClutterLayoutManagerClass *layout_class = CLUTTER_LAYOUT_MANAGER_CLASS (klass);
  GObjectClass *gobject_class = G_OBJECT_CLASS (klass);

  layout_class->get_preferred_width = cinnamon_window_preview_layout_get_preferred_width;
  layout_class->get_preferred_height = cinnamon_window_preview_layout_get_preferred_height;
  layout_class->allocate = cinnamon_window_preview_layout_allocate;
  layout_class->set_container = cinnamon_window_preview_layout_set_container;

  gobject_class->dispose = cinnamon_window_preview_layout_dispose;
  gobject_class->get_property = cinnamon_window_preview_layout_get_property;

  /**
   * CinnamonWindowPreviewLayout:bounding-box:
   */
...
/**
 * cinnamon_window_preview_layout_add_window:
 * @self: a #CinnamonWindowPreviewLayout
 ...
 */
ClutterActor *
cinnamon_window_preview_layout_add_window (CinnamonWindowPreviewLayout *self,
                                        MetaWindow               *window)
{
  CinnamonWindowPreviewLayoutPrivate *priv;
...
/**
 * cinnamon_window_preview_layout_remove_window:
 * @self: a #CinnamonWindowPreviewLayout
 * @window: the #MetaWindow
 *
 * Removes a MetaWindow @window from the preview which has been added
 * previously using cinnamon_window_preview_layout_add_window().
 * If @window is not part of preview, this function will do nothing.
 */
void
cinnamon_window_preview_layout_remove_window (CinnamonWindowPreviewLayout *self,
                                           MetaWindow               *window)
{
  CinnamonWindowPreviewLayoutPrivate *priv;
  ClutterActor *actor;
...
/**
 * cinnamon_window_preview_layout_get_windows:
 * @self: a #CinnamonWindowPreviewLayout
 *
 * Gets an array of all MetaWindows that were added to the layout
 * using cinnamon_window_preview_layout_add_window(), ordered by the
 * insertion order.
 *
 * Returns: (transfer container) (element-type Meta.Window): The list of windows
 */
GList *
cinnamon_window_preview_layout_get_windows (CinnamonWindowPreviewLayout *self)
{
  CinnamonWindowPreviewLayoutPrivate *priv;
  GList *windows = NULL;
  GHashTableIter iter;
